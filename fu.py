...
\n---------------------------------------------------------------------\
\nName     Busy      Opt    Fi    Fj    Fk   Qj         Qk         Rj    Rk\
\n---------------------------------------------------------------------"
...
class FunctionalUnit:
  ...
  def __str__(self):
    ...
    return "%-7s%6s%9s%6s%6s%6s  %-9s  %-9s%6s%6s" % \
        (self.type, self.busy, self.opt,
            self.fi, self.fj, self.fk,
            repr(self.qj), repr(self.qk), rj, rk)
